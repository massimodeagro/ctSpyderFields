...
import cv2
import VisualFieldFinder
import numpy as np

'''
path = 'C:/Users/lauren.sumner-rooney/Documents/DragonflyProjects/AmiraTiffs/Misumena_vatia/Labels/' #write path of folder containing data


MisumenaVatia = VisualFieldFinder.Spider(path=path)
MisumenaVatia.amira_load_labels()
MisumenaVatia.amira_find_all_points()
'''
...
PhilaeusChrysops = VisualFieldFinder.Spider(path=path, dragonfly_label_names=phillabelnames)
